...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_universal(
    ...
    KC_RCMD   , S(KC_9)    , S(KC_0)     , KC_BSLS    ,S(KC_BSLS)  ,               KC_NO  , KC_LEFT  , KC_DOWN , KC_RGHT, KC_LALT  ,
    KC_RSFT   , S(KC_LBRC) , S(KC_RBRC)  , S(KC_QUOT) ,KC_QUOT     ,               KC_NO  , C(S(KC_TAB))    , KC_NO   , C(KC_TAB)  , KC_RSFT  ,

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  // 0: 
  [0] = LAYOUT_universal(
    KC_NO,  MT(MOD_RCTL, KC_Q),    KC_W,    KC_E,    KC_R,    KC_T,                                           KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,      KC_NO,
    KC_NO,             KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                                           KC_H,    KC_J,    KC_K,    KC_L,    KC_BTN1,   KC_NO,
    MO(1),             KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                           KC_N,    KC_M,    MT(MOD_LCTL, KC_COMM), MT(MOD_RGUI,KC_DOT), MT(MOD_RSFT, KC_BTN2), KC_NO,
                      KC_ESC,  KC_LALT, MT(MOD_LGUI,KC_BSPC), LT(2,KC_SPC), MT(MOD_LCTL,KC_TAB) ,                       LT(2, KC_LNG2), KC_ENT, MT(MOD_LSFT,KC_TAB), _______,   MO(3)
  ),
  ...
  [1] = LAYOUT_universal(
    ...
    KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                                            KC_PDOT, KC_KP_1, KC_KP_2, KC_KP_3, KC_TRNS,   KC_NO,
                      KC_NO,   KC_NO,   _______,          _______,          _______,              _______, KC_TRNS, KC_TRNS, _______,   _______
  ),

  // 2: 
  [2] = LAYOUT_universal(
    KC_NO, KC_RCTL, KC_LBRC, KC_RBRC, KC_SCLN, S(KC_SCLN),                                       KC_NO,   KC_HOME, KC_UP,   KC_END,  KC_NO,     KC_NO,
    KC_NO, KC_RCMD, S(KC_9), S(KC_0), KC_BSLS, S(KC_BSLS),                                       KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS,   KC_NO,
    KC_NO, KC_RSFT, S(KC_LBRC), S(KC_RBRC), S(KC_QUOT), KC_QUOT,                                 KC_NO, C(S(KC_TAB)), KC_NO, C(KC_TAB), KC_TRNS,   KC_NO,
                    S(KC_COMM), S(KC_DOT),KC_NO , _______,          _______,                   _______, KC_TRNS, KC_TRNS, _______,   _______
  ),
  ...
  [3] = LAYOUT_universal(
    ...
    S(KC_GRV), S(KC_GRV), S(KC_7), S(KC_MINS), S(KC_SLSH), S(KC_1),                                 KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,     KC_NO,
                      KC_NO,   KC_GRV,  _______,          _______,          _______,              _______, KC_LNG1, _______, _______,   _______
  ),
};
// clang-format on
